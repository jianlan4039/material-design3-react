...
export interface UseListExpandPresenceProps {
  expanded: boolean;
  duration?: number;
  easing?: string;
...
export interface UseListExpandPresenceResult {
  shouldRender: boolean;
  isPreparingOpen: boolean;
  containerRef: (element: HTMLDivElement | null) => void;
}

const useListExpandPresence = ({
  expanded,
  duration,
  easing,
  onExpandComplete,
  onCollapseComplete,
}: UseListExpandPresenceProps): UseListExpandPresenceResult => {
...
export default useListExpandPresence;
